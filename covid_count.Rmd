...
```{r}
us.counties <- read.csv("C:/Users/echel/Desktop/us-counties.txt")
...
```{r}
mask_use <- read.csv("C:/Users/echel/Desktop/mask-use-by-county.txt")
...
# health data
```{r}
health2019 <- read.csv("C:/Users/echel/Desktop/analytic_data2019.csv")
```
...
# party preferrence
```{r}
county_vote_2016 <- read.csv("C:/Users/echel/Desktop/countypres_2000-2016.csv")     # read in data
...
```{r}
full_data <- merge(full_data, county_vote_2016[,c(1,4)], by = "fips", all.x = TRUE, all.y = TRUE)     # Keep all rows of both data frames
```
